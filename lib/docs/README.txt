...
этого, спекуляция характеризуется временем начала и завершения. В базовой версии
спекуляция не характерирузется никакими иными данными, кроме сигнала на вход,
фактическими данными входа в позицию и выхода из нее. 
