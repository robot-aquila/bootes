 ...
 * Block report.
 * <p>
 * Каждый отчет представляется группой информационных блоков, содержащих значимую
 * информацию об операции. Например, цена открытия, цена тейк-профита и стоп-лосса,
