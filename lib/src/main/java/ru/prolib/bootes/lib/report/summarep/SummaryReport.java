...
public class SummaryReport implements ISummaryReport {
	...
	public SummaryReport(
			...
			SRTradeSSI maximumConsecutiveWins,
			SRTradeSSI maximumConsecutiveLosses,
			SRTradeSSI maximalConsecutiveProfit,
			SRTradeSSI maximalConsecutiveLoss)
	{
	...
	@Override
	public SRTradeSSI getMaximumConsecutiveWins() {
		return maximumConsecutiveWins;
	}

	@Override
	public SRTradeSSI getMaximumConsecutiveLosses() {
		return maximumConsecutiveLosses;
	}

	@Override
	public SRTradeSSI getMaximalConsecutiveProfit() {
		return maximalConsecutiveProfit;
	}

	@Override
	public SRTradeSSI getMaximalConsecutiveLoss() {
