...
public class ContractResolverM3RTSTest {
	...
	public void testDetermineContract() {
		...
		expected = new ContractParams(sym, INT(ZDT("2005-01-01T09:55:00"), ZDT("2005-01-01T23:55:00")));
		...
		expected = new ContractParams(sym, INT(ZDT("2005-03-01T09:55:00"), ZDT("2005-03-01T23:55:00")));
		...
		expected = new ContractParams(sym, INT(ZDT("2005-03-02T09:55:00"), ZDT("2005-03-02T23:55:00")));
		...
		expected = new ContractParams(sym, INT(ZDT("2005-03-14T09:55:00"), ZDT("2005-03-14T23:55:00")));
		...
		expected = new ContractParams(sym, INT(ZDT("2005-03-15T09:55:00"), ZDT("2005-03-15T23:55:00")));
		...
		expected = new ContractParams(sym, INT(ZDT("2005-04-01T09:55:00"), ZDT("2005-04-01T23:55:00")));
		assertEquals(expected, service.determineContract(ZDT("2005-04-01T00:00:00")));
		
		expected = new ContractParams(sym, INT(ZDT("2005-05-31T09:55:00"), ZDT("2005-05-31T23:55:00")));
		assertEquals(expected, service.determineContract(ZDT("2005-05-30T20:45:00")));
		
		expected = new ContractParams(sym, INT(ZDT("2005-06-01T09:55:00"), ZDT("2005-06-01T23:55:00")));
		...
		expected = new ContractParams(sym, INT(ZDT("2005-06-15T09:55:00"), ZDT("2005-06-15T23:55:00")));
		...
		expected = new ContractParams(sym, INT(ZDT("2005-09-15T09:55:00"), ZDT("2005-09-15T23:55:00")));
		...
		expected = new ContractParams(sym, INT(ZDT("2005-12-01T09:55:00"), ZDT("2005-12-01T23:55:00")));
		assertEquals(expected, service.determineContract(ZDT("2005-12-01T00:00:00")));
		
		expected = new ContractParams(sym, INT(ZDT("2005-12-14T09:55:00"), ZDT("2005-12-14T23:55:00")));
		...
		expected = new ContractParams(sym, INT(ZDT("2005-12-15T09:55:00"), ZDT("2005-12-15T23:55:00")));
		...
		expected = new ContractParams(sym, INT(ZDT("2006-01-01T09:55:00"), ZDT("2006-01-01T23:55:00")));
		...
		expected = new ContractParams(sym, INT(ZDT("2018-10-31T09:55:00"), ZDT("2018-10-31T23:55:00")));
		assertEquals(expected, service.determineContract(ZDT("2018-10-30T23:59:59")));
		
		sym = new Symbol("RTS-3.19");
		expected = new ContractParams(sym, INT(ZDT("2018-12-15T09:55:00"), ZDT("2018-12-15T23:55:00")));
		...
		expected = new ContractParams(sym, INT(ZDT("2019-01-01T09:55:00"), ZDT("2019-01-01T23:55:00")));
