...
public class BlockReportUtilsTest {
	...
	private BlockReportUtils service;
	...
	public void setUp() throws Exception {
		...
		service = new BlockReportUtils();
	}
	
	@Test
	public void testGetInstance() {
		BlockReportUtils actual = BlockReportUtils.getInstance();
		assertNotNull(actual);
		assertSame(BlockReportUtils.getInstance(), actual);
		assertSame(BlockReportUtils.getInstance(), actual);
	}
