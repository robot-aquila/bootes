...
public class SummaryReportTrackerTest {
	...
	public void testDefaults() {
		...
		assertEquals(new SRTradeSSI(ZERO_RUB5, 0), stats.getMaximumConsecutiveWins());
		assertEquals(new SRTradeSSI(ZERO_RUB5, 0), stats.getMaximumConsecutiveLosses());
		assertEquals(new SRTradeSSI(ZERO_RUB5, 0), stats.getMaximalConsecutiveProfit());
		assertEquals(new SRTradeSSI(ZERO_RUB5, 0), stats.getMaximalConsecutiveLoss());
	...
	public void testAdd_SimpleCase() {
		...
		assertEquals(new SRTradeSSI(ofRUB5("474.22"), 5), stats.getMaximumConsecutiveWins());
		assertEquals(new SRTradeSSI(ofRUB5("-283.2"), 2), stats.getMaximumConsecutiveLosses());
		// this case they are same
		assertEquals(new SRTradeSSI(ofRUB5("474.22"), 5), stats.getMaximalConsecutiveProfit());
		assertEquals(new SRTradeSSI(ofRUB5("-283.2"), 2), stats.getMaximalConsecutiveLoss());
