...
public class TSGR001ARobotComp implements AppComponent {
	...
	public void init() throws Throwable {
		...
		robot = new TSGR001ARobotBuilder(serviceLocator, reports)
		...
		if ( ! appConfig.getBasicConfig().isHeadless() ) {
			state.getStateListener()
				.addListener(new RobotUIService(serviceLocator, reports, state));
		}
	...
	public void shutdown() throws Throwable {
		...
		reports.save(report_dir, new StringBuilder()
				.append("tsgr001a-")
